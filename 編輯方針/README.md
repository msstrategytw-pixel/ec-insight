...
先把「[AI 協作說明](AI協作說明.md)」整份貼給 AI（ChatGPT／Claude／Gemini 皆可），再貼上要改的方針內容與你的需求。那份說明會告訴 AI：這些文件其實是餵給 agent 的指令、改動會造成什麼後果、哪些東西不能亂動。**沒有給脈絡就請 AI 改，很容易被改成讀起來漂亮但 agent 無法執行的版本。**
